...
export const Item: IntItem[] = [
  {
    ...
    Codigo: "0002",
    Descricao: "Pizza de Calabresa Suprema",
    Complemento: "",
    DescReduzida: null,
    Foto: null,
    PrecoValor: 0.0,
    Composicao: false,
    DescLonga:
      "o segredo da pizza calabresa está na harmonia dos ingredientes. A massa fininha e crocante juntamente com o molho de tomate trazem um sabor especial aos pedaços generosos de linguiça calabresa, que possuem um sabor defumado e levemente picante",
    ComposicaoBarra: "NÃO",
  ...
  },
  {
    ...
    Composicao: false,
    DescLonga:
      "hambúrguer coberto com queijo e que geralmente é servido com alface, tomate, cebola, picles, mostarda, maionese, ketchup, e, ocasionalmente, bacon",
    ComposicaoBarra: "NÃO",
    NaoPermiteDesconto: false,
    DescricaoDif: null,
    VendaValor: 17.5,
