...
//     DEEPLINK_RETURN: params.get("DEEPLINK_RETURN") ?? undefined,
//   };

//   switch (extractedParams.DEEPLINK_RETURN) {
//     case "SUCCESS":
//       ToastAndroid.show("Impressão realizada com sucesso.", ToastAndroid.SHORT);
//       break;
...
//       ToastAndroid.show("Superaquecimento da impressora.", ToastAndroid.SHORT);
//       break;
//     case "PRINTER_PAPER_JAM":
//       ToastAndroid.show("Papel preso na caixa de bobina.", ToastAndroid.SHORT);
//       break;
